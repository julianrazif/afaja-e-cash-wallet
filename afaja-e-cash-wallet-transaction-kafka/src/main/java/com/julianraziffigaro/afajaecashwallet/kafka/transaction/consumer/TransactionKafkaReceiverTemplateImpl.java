package com.julianraziffigaro.afajaecashwallet.kafka.transaction.consumer;
...
@Component
public class TransactionKafkaReceiverTemplateImpl implements KafkaReceiverTemplate {
